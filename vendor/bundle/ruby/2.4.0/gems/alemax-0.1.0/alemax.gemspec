...
Gem::Specification.new do |spec|
  spec.name          = "alemax"
  spec.license       = "MIT"
  spec.version       = Alemax::VERSION
  spec.authors       = ["Alemax"]
  spec.email         = ["leualemax@gmail.com"]

  spec.summary       = %q{Ola todo mundo}
  spec.homepage      = "http://leualemax.github.io"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "http://leualemax.github.io/code"
    spec.metadata["changelog_uri"] = "http://leualemax.github.io/changelog"
  else
